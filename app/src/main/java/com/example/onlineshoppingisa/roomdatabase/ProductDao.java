...
//    void delete(ProductRoom productRoom);
    ...
    @Query("delete from ProductRoom where userId like :userId and productId like :productId")
    Completable deleteDataForUser(String userId, String productId);
    ...
    void deleteAllOrderFromUser(String userId);
